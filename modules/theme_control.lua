...
OB_MODULES["theme_ctl_brutaldoom"] =
{
  label = _("Brutal Doom Theme Control")
  ...
  options =
  {
    episode1  = { label="Episode 1",     choices=THEME_CONTROL.BD_CHOICES }
    episode2  = { label="Episode 2",     choices=THEME_CONTROL.BD_CHOICES }
    episode3  = { label="Episode 3",     choices=THEME_CONTROL.BD_CHOICES }
    secret    = { label="Secret Levels", choices=THEME_CONTROL.BD_CHOICES }
  }
}