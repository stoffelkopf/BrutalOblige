...
-- Brightness Settings from Miscellaneous Stuff
  local light_offset = 0
  if PARAM.brightness_settings == "-3" then
    light_offset = -48
  elseif PARAM.brightness_settings == "-2" then
    light_offset = -24
  elseif PARAM.brightness_settings == "-1" then
    light_offset = -16
  elseif PARAM.brightness_settings == "+1" then
    light_offset = 16
  elseif PARAM.brightness_settings == "+2" then
    light_offset = 24
  elseif PARAM.brightness_settings == "+3" then
    light_offset = 48
  else
    light_offset = 0
  end  
